# Scaling Guide: MDM API
**Primary Responsibility:** Enforces master-data standardization and validation for shared enterprise entities.
...
- [ ] Global entity deduplication rule set
- [ ] Cross-service master data versioning
