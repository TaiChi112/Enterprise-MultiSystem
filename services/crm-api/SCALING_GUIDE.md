# Scaling Guide: CRM API
**Primary Responsibility:** Maintains customer profiles, loyalty points, and customer-centric lifecycle operations.
...
- [ ] Omnichannel contact timeline
- [ ] Loyalty tier expiration policy
